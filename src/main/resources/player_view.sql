...
SELECT
    ...
    avg(mp.psv_99) AS total_psv_99,  -- PSV 99, z.B. % der maximalen Sprintgeschwindigkeit
    ...
    avg(mp.time_to_505_around_90) AS total_time_to_505_90,  -- Zeit für 5-0-5-Test um 90° (Sekunden)
    avg(mp.time_to_505_around_180) AS total_time_to_505_180  -- Zeit für 5-0-5-Test um 180° (Sekunden)
